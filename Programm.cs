    ...
    class Programm
    {
        static void Main(string[] args)
        {
            ...
            var father = new FamilyMember()
                { Mother = grandMother, Father = grandFather, Name = "John111", Sex = Gender.Male, BirthDay = new DateTime(1993, 01, 13) };
            ...
            var mother1 = new FamilyMember()
                { Mother = null, Father = null, Name = "mother1", Sex = Gender.Female, BirthDay = new DateTime(1993, 07, 24) };
            ...
            var mother2 = new FamilyMember()
                { Mother = null, Father = null, Name = "mother2", Sex = Gender.Female, BirthDay = new DateTime(1993, 07, 24) };
            ...
            var son22 = new FamilyMember()
                { Mother = mother2, Father = son2, Name = "Joshua1", Sex = Gender.Male, BirthDay = new DateTime(2015, 12, 01) };
            var son23 = new FamilyMember()
                { Mother = mother2, Father = son2, Name = "Joshua2", Sex = Gender.Male, BirthDay = new DateTime(2015, 12, 01) };

            grandFather.Spouse = grandMother;
            grandFather.Children = new FamilyMember[] { father };
            grandMother.Children = new FamilyMember[] { father };
